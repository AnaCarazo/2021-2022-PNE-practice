...
# --- Main program, pero en esta parte sólo usamos cosas de la clase Seq()
s1 = Seq("AGTACACTGGT")
s2 = Seq("CGTAAC")
...
# --- Main program, en esta parte combinamos cosas de la clase Seq() y Gen(Seq)
s1 = Seq("AGTACACTGGT")
g = Gene("CGTAAC", "FRAT1")
